...
//	private OnItemClickListener newDeviceClickListener = new OnItemClickListener()
//	{
//		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3)
//		{
//			try
...
//					try
//					{
//						ClsUtils.setPin(BluetoothDevice.class, device, "1234");
...
//	};
	...
	Handler handle = new Handler()
	{
		public void handleMessage(android.os.Message msg)
		{
			...
			if (msg.what == 0)
			{
				if (mBtAdapter.getBondedDevices() != null && mBtAdapter.getBondedDevices().size() > 0)
				{
