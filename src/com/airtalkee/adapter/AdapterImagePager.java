...
public class AdapterImagePager extends PagerAdapter
{
	...
	public AdapterImagePager(List<String> images, Context context)
	{
		...
		options = new DisplayImageOptions.Builder().showImageForEmptyUri(R.drawable.msg_image).showImageOnFail(R.drawable.msg_image).resetViewBeforeLoading(true)
	...
	public Object instantiateItem(ViewGroup view, int position)
	{
		...
		String url = images.get(position).contains("http://") ? images.get(position) : Util.getPhotoUrl(images.get(position));
