...
public class PagerControl extends View
{
	...
	public PagerControl(Context context, AttributeSet attrs, int defStyle)
	{
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.com_cmccpoc_widget_PagerControl);
		int barColor = a.getColor(R.styleable.com_cmccpoc_widget_PagerControl_barColor, DEFAULT_BAR_COLOR);
		int highlightColor = a.getColor(R.styleable.com_cmccpoc_widget_PagerControl_highlightColor, DEFAULT_HIGHLIGHT_COLOR);
		fadeDuration = a.getInteger(R.styleable.com_cmccpoc_widget_PagerControl_fadeDuration, DEFAULT_FADE_DURATION);
		ovalRadius = a.getDimension(R.styleable.com_cmccpoc_widget_PagerControl_roundRectRadius, 0f);
		a.recycle();
