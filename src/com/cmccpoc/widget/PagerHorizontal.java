...
public class PagerHorizontal extends ViewGroup
{
	...
	public PagerHorizontal(Context context, AttributeSet attrs, int defStyle)
	{
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.com_cmccpoc_widget_PagerHorizontal);
		pageWidthSpec = a.getDimensionPixelSize(R.styleable.com_cmccpoc_widget_PagerHorizontal_pageWidth, SPEC_UNDEFINED);
		a.recycle();
